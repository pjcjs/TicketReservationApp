...
public class TicketReservationApp {
    ...
    private static void start() {
        ...
        int select;//DEVAM : bir sayı ÇIKIŞ :0
        ...
        do {
            ...
            String seatNo=scanner.next();//2-42

            //koltuk no rezerve edilmiş mi veya otobüste mevcut mu
            boolean isReserved=!bus.getSeats().contains(seatNo);
            //isReserved: TRUE ise rezerve edilmiş veya otobüste yok
